      ...
      <div class="${this.modalContainerClass}">
        ...
        ${this.isPrivateLobby()
          ? html`
              ...
              >
                <button
                  class="w-full py-4 text-sm font-bold text-white uppercase tracking-widest bg-purple-600 hover:bg-purple-500 disabled:opacity-50 disabled:cursor-not-allowed rounded-xl transition-all shadow-lg shadow-purple-900/20 hover:shadow-purple-900/40 hover:-translate-y-0.5 active:translate-y-0 disabled:transform-none"
                  disabled
                >
